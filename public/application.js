...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SnippetAdd = __webpack_require__(9);

	var _SnippetAdd2 = _interopRequireDefault(_SnippetAdd);

	var _SnippetList = __webpack_require__(47);
	...
	var _SnippetRecord = __webpack_require__(58);

	var _SnippetRecord2 = _interopRequireDefault(_SnippetRecord);

	var _SnippetUpdate = __webpack_require__(59);
	...
	var config = __webpack_require__(6);
	var api = config.apiOrigins.production;
	...
	var SnippetApp = function (_React$Component) {
	  ...
	  function SnippetApp() {
	    ...
	    _this.loginStatus = _this.loginStatus.bind(_this);
	    _this.showHideComponent = _this.showHideComponent.bind(_this);
	    _this.loadSnippets = _this.loadSnippets.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(SnippetApp, [{
	    ...
	    key: 'showHideComponent',
	    value: function showHideComponent(stateArr) {
	      var trueVal = stateArr[0];
	      var emptyFalse = void 0;
	      var emptyTrue = void 0;
	    ...
	    key: 'loginStatus',
	    value: function loginStatus(bool) {
	      {
	        if (bool) {
	          this.setState({
	            userSignedIn: true
	    ...
	    value: function render() {
	      ...
	      var signedIn = this.state.userSignedIn;
	      var showHomepage = this.state.showHomepage;

	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_Navigation2.default, { showHideComponent: this.showHideComponent, userSignedIn: this.state.userSignedIn, loginStatus: this.loginStatus, findSearchResults: this.findSearchResults, displayComponent: this.displayComponent, snippetsState: this.state.showSnippets, createState: this.state.showCreate }),
	        showHomepage ? _react2.default.createElement(_Homepage2.default, null) : null,
	        showSnippets ? _react2.default.createElement(_SnippetList2.default, { showHideComponent: this.showHideComponent, snippets: this.state.snippets, userSignedIn: this.state.userSignedIn, snippetRecord: this.snippetRecord, displayComponent: this.displayComponent }) : null,
	        showCreate ? _react2.default.createElement(_SnippetAdd2.default, { showHideComponent: this.showHideComponent, showCreate: this.state.showCreate, displayComponent: this.displayComponent, loadSnippets: this.loadSnippets }) : null,
	        showSnippet ? _react2.default.createElement(_SnippetRecord2.default, { loadSnippets: this.loadSnippets, showHideComponent: this.showHideComponent, record: this.state.record, snippetEdit: this.snippetEdit, showSnippet: this.state.showSnippet, displayComponent: this.displayComponent }) : null,
	        showUpdate ? _react2.default.createElement(_SnippetUpdate2.default, { loadSnippets: this.loadSnippets, showHideComponent: this.showHideComponent, snippet: this.state.editRecord, showUpdate: this.state.showUpdate, displayComponent: this.displayComponent }) : null,
	        showSearchResults ? _react2.default.createElement(_SnippetList2.default, { showHideComponent: this.showHideComponent, snippets: this.state.searchResults, snippetRecord: this.snippetRecord, displayComponent: this.displayComponent }) : null
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SnippetAdd = function (_React$Component) {
	  ...
	  _createClass(SnippetAdd, [{
	    ...
	    key: 'createSnippetSuccess',
	    value: function createSnippetSuccess() {
	      this.setState({
	        createError: false
	      });
	    ...
	    key: 'createSnippetFail',
	    value: function createSnippetFail() {
	      return this.setState({
	        createError: true
	      });
	    }
	  }, {
	    key: 'createSnippetServerFail',
	    value: function createSnippetServerFail() {
	      return this.setState({
	        createError: true
	      });
	    }
	    ...
	    key: 'createSnippet',
	    value: function createSnippet(data) {
	      var _this2 = this;
	      ...
	      fetch(api + '/snippets', {
	        ...
	        if (response.ok) {
	          _this2.createSnippetSuccess();
	          return;
	        } else {
	          response.json().then(function (error) {
	            console.log("Failed to add snippet: " + error.message);
	            _this2.createSnippetFail();
	          });
	        }
	      }).catch(function (err) {
	        console.log("Error in sending data to server: " + err.message);
	        _this2.createSnippetServerFail();
	      });
	    }
	  }, {
	    key: 'handleSubmit',
	    ...
	    key: 'render',
	    value: function render() {
	      var isError = this.state.createError;
	      return _react2.default.createElement(
	        'div',
	        null,
	        ...
	        _react2.default.createElement(
	          ...
	          isError ? _react2.default.createElement(
	            'p',
	            { className: 'error' },
	            'There was an error creating your snippet. Please make sure all required fields are complete and try again.'
	          ) : null,
	          _react2.default.createElement(
	            'div',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SnippetList = function (_React$Component) {
	  ...
	  _createClass(SnippetList, [{
	    ...
	    key: 'snippetCount',
	    value: function snippetCount(snippets) {
	      var snippetLength = snippets.length;
	    ...
	    value: function render() {
	      ...
	      var snippetsExist = this.snippetCount(snippets);
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
	        ...
	        snippetsExist ? _react2.default.createElement(
	          'table',
	    ...
	    value: function snippetRows() {
	      ...
	      return this.props.snippets.map(function (snippet) {
	        return _react2.default.createElement(SnippetRow, {
	          key: snippet.id,
	          snippet: snippet,
	          showHideComponent: _this2.props.showHideComponent,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Prelogin = __webpack_require__(49);

	var _Prelogin2 = _interopRequireDefault(_Prelogin);

	var _Postlogin = __webpack_require__(52);
	...
	var _Navlinks = __webpack_require__(57);
	...
	var Navigation = function (_React$Component) {
	  ...
	  _createClass(Navigation, [{
	    key: 'render',
	    value: function render() {
	      var postLoginDisplay = this.props.userSignedIn;
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              null,
	              postLoginDisplay ? _react2.default.createElement(_Navlinks2.default, { showHideComponent: this.props.showHideComponent }) : null,
	              postLoginDisplay ? _react2.default.createElement(_Search2.default, { snippetsExist: this.props.snippetsExist, findSearchResults: this.props.findSearchResults }) : null,
	              postLoginDisplay ? _react2.default.createElement(_Postlogin2.default, { loginStatus: this.props.loginStatus }) : _react2.default.createElement(_Prelogin2.default, { loginStatus: this.props.loginStatus })
	            )
	          )
	        )
	      );
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Prelogin = function (_React$Component) {
	  ...
	  function Prelogin() {
	    ...
	    var _this = _possibleConstructorReturn(this, (Prelogin.__proto__ || Object.getPrototypeOf(Prelogin)).call(this));
	    ...
	    _this.credentialSwitch = _this.credentialSwitch.bind(_this);
	    _this.signInRequest = _this.signInRequest.bind(_this);
	    _this.handleClearError = _this.handleClearError.bind(_this);
	    _this.signUpErrorMessage = _this.signUpErrorMessage.bind(_this);
	  ...
	  _createClass(Prelogin, [{
	    ...
	    value: function handleClearError(event) {
	      event.preventDefault();
	      this.setState({
	        signInError: false,
	        signUpError: false
	    ...
	    key: 'credentialSwitch',
	    value: function credentialSwitch(event) {
	      event.preventDefault();
	      var currentShowState = this.state.showSignIn;
	      var stateObject = {};
	    ...
	    key: 'signInServerFail',
	    value: function signInServerFail() {
	      this.setState({
	        signInError: true
	      });
	      return;
	    ...
	    value: function signUpErrorMessage(bool) {
	      if (bool) {
	        return this.setState({
	          signUpError: true
	        });
	    ...
	    key: 'signInRequest',
	    value: function signInRequest(data) {
	      var _this2 = this;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { className: 'dropdown-toggle', 'data-toggle': 'dropdown', href: '#', onClick: this.handleClearError },
	              'Login ',
	            ...
	            _react2.default.createElement(
	              ...
	              showSignIn ? _react2.default.createElement(_SignIn2.default, { signInRequest: this.signInRequest, signInErrorStatus: this.state.signInError, loginStatus: this.props.loginStatus, credentialSwitch: this.credentialSwitch }) : _react2.default.createElement(_SignUp2.default, { signUpErrorStatus: this.state.signUpError, signInRequest: this.signInRequest, credentialSwitch: this.credentialSwitch, signUpErrorMessage: this.signUpErrorMessage })
	            )
	          )
	        )
	      );
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SignIn = function (_React$Component) {
	  ...
	  _createClass(SignIn, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var signInError = this.props.signInErrorStatus;
	      return _react2.default.createElement(
	        'div',
	        { className: 'container-fluid' },
	        _react2.default.createElement(
	        ...
	        signInError ? _react2.default.createElement(
	          'p',
	          { className: 'error' },
	          'There has been an error signing in.  Please try again.'
	        ) : null,
	        _react2.default.createElement(
	          'form',
	          { className: 'form login-form', name: 'signInForm', onSubmit: this.handleLoginSubmit },
	          _react2.default.createElement(
	            'div',
	            { className: 'form-group' },
	            _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { type: 'submit', id: 'btnLogin', className: 'btn btn-block btn-success btn-lg', value: 'Sign-In' }),
	          _react2.default.createElement(
	            'div',
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'a',
	                { href: '#', className: 'register-text', onClick: this.props.credentialSwitch },
	                'Not a member?'
	              ),
	              _react2.default.createElement(
	                'button',
	                { className: 'btn btn-primary', onClick: this.props.credentialSwitch },
	                'Sign-Up'
	              )
	            )
	          )
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SignUp = function (_React$Component) {
	  ...
	  _createClass(SignUp, [{
	    key: 'signUpSuccess',
	    value: function signUpSuccess() {
	      this.props.signUpErrorMessage(false);
	      return this.props.loginStatus(true);
	    }
	  }, {
	    key: 'signUpFail',
	    value: function signUpFail() {
	      return this.props.signUpErrorMessage(true);
	    }
	  }, {
	    key: 'signUpServerFail',
	    value: function signUpServerFail() {
	      return this.props.signUpErrorMessage(true);
	    }
	  }, {
	    key: 'signUpRequest',
	    value: function signUpRequest(data) {
	      var _this2 = this;
	    ...
	    key: 'render',
	    value: function render() {
	      var signUpError = this.props.signUpErrorStatus;
	      ...
	      return _react2.default.createElement(
	        ...
	        signUpError ? _react2.default.createElement(
	          'p',
	          { className: 'error' },
	          'There has been an error signing-up.  Please try again'
	        ) : null,
	        _react2.default.createElement(
	          'form',
	          { className: 'form login-form', name: 'signUpForm', onSubmit: this.handleSubmit },
	          _react2.default.createElement(
	            'div',
	            { className: 'form-group' },
	            _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', { type: 'password', className: 'form-control', name: 'password-confirmation' })
	          ),
	          _react2.default.createElement('input', { type: 'submit', className: 'btn btn-block btn-lg btn-success', value: 'Sign-Up' }),
	          _react2.default.createElement(
	            'div',
	            { className: 'register-bg' },
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'a',
	                { className: 'register-text', onClick: this.props.credentialSwitch },
	                'Already a member?'
	              ),
	              _react2.default.createElement(
	                'button',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ChangePasswordBtn = __webpack_require__(54);

	var _ChangePasswordBtn2 = _interopRequireDefault(_ChangePasswordBtn);

	var _ChangePasswordForm = __webpack_require__(55);
	...
	var PostLogin = function (_React$Component) {
	  _inherits(PostLogin, _React$Component);

	  function PostLogin() {
	    _classCallCheck(this, PostLogin);

	    var _this = _possibleConstructorReturn(this, (PostLogin.__proto__ || Object.getPrototypeOf(PostLogin)).call(this));

	    _this.state = {
	      displayCPForm: false
	    };

	    _this.changeDisplayState = _this.changeDisplayState.bind(_this);
	    _this.changeOpenState = _this.changeOpenState.bind(_this);
	    return _this;
	  }

	  _createClass(PostLogin, [{
	    key: 'changeDisplayState',
	    value: function changeDisplayState(stateStatus) {
	      var emptyObj = {};
	    ...
	    key: 'changeOpenState',
	    value: function changeOpenState(stateStatus) {
	      if (stateStatus) {
	        this.setState({
	          displayCPForm: false
	        });
	    ...
	    key: 'render',
	    value: function render() {
	      var displayForm = this.state.displayCPForm;
	      return _react2.default.createElement(
	        'div',
	        null,
	        displayForm ? _react2.default.createElement(_ChangePasswordForm2.default, { changeOpenState: this.changeOpenState, changeDisplayState: this.changeDisplayState }) : _react2.default.createElement(_ChangePasswordBtn2.default, { loginStatus: this.props.loginStatus, changeDisplayState: this.changeDisplayState })
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SignOut = function (_React$Component) {
	  ...
	  function SignOut() {
	    ...
	    _this.signOutRequest = _this.signOutRequest.bind(_this);
	    return _this;
	  }

	  _createClass(SignOut, [{
	    key: 'signOutSuccess',
	    value: function signOutSuccess() {
	      return this.props.loginStatus(false);
	    }
	  }, {
	    key: 'signOutRequest',
	    value: function signOutRequest(event) {
	      var _this2 = this;

	      event.preventDefault();
	      this.signOutSuccess = this.signOutSuccess.bind(this);
	      fetch(api + '/sign-out/' + store.user.id, { method: 'DELETE',
	        headers: { 'Authorization': 'Token token=' + store.user.token }
	      }).then(function (response) {
	        if (!response.ok) {
	          console.log('Failed to Sign-out');
	        } else {
	          _this2.signOutSuccess();
	        }
	      });
	    }
	  }, {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: '#', onClick: this.signOutRequest },
	          'Sign Out'
	        )
	      );
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ChangePasswordBtn = function (_React$Component) {
	  _inherits(ChangePasswordBtn, _React$Component);

	  function ChangePasswordBtn() {
	    _classCallCheck(this, ChangePasswordBtn);

	    var _this = _possibleConstructorReturn(this, (ChangePasswordBtn.__proto__ || Object.getPrototypeOf(ChangePasswordBtn)).call(this));

	    _this.handleCPClick = _this.handleCPClick.bind(_this);
	    return _this;
	  }

	  _createClass(ChangePasswordBtn, [{
	    key: 'handleCPClick',
	    value: function handleCPClick(event) {
	      event.preventDefault();
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'a',
	                  { href: '#', onClick: this.handleCPClick },
	                  'Change Password'
	                )
	              ),
	              _react2.default.createElement(_SignOut2.default, { loginStatus: this.props.loginStatus })
	            )
	          )
	        )
	      );
	...
	exports.default = ChangePasswordBtn;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ChangePasswordForm = function (_React$Component) {
	  ...
	  function ChangePasswordForm() {
	    ...
	    var _this = _possibleConstructorReturn(this, (ChangePasswordForm.__proto__ || Object.getPrototypeOf(ChangePasswordForm)).call(this));
	    ...
	    _this.handleCancel = _this.handleCancel.bind(_this);
	    _this.handleSubmit = _this.handleSubmit.bind(_this);
	    _this.clearPasswordErrors = _this.clearPasswordErrors.bind(_this);
	    return _this;
	  }

	  _createClass(ChangePasswordForm, [{
	    key: 'clearPasswordErrors',
	    value: function clearPasswordErrors() {
	      return this.setState({
	        passwordError: false
	      });
	    }
	    ...
	    value: function changePasswordSuccess() {
	      this.setState({
	        passwordError: false
	      });
	    ...
	    value: function changePasswordFail() {
	      return this.setState({
	        passwordError: true
	      });
	    }
	  }, {
	    key: 'changePasswordServerFail',
	    value: function changePasswordServerFail() {
	      return this.setState({
	        passwordError: true
	      });
	    }
	  }, {
	    key: 'ChangePasswordSnippet',
	    value: function ChangePasswordSnippet(data) {
	      var _this2 = this;
	      ...
	      fetch(api + '/change-password/' + store.user.id, {
	        ...
	        if (response.ok) {
	          _this2.changePasswordSuccess();
	        } else {
	          _this2.changePasswordFail();
	        }
	      }).catch(function (error) {
	        console.log("Error in sending data to server: " + error.message);
	        _this2.changePasswordServerFail();
	      });
	    }
	  }, {
	    key: 'handleSubmit',
	    ...
	    key: 'render',
	    value: function render() {
	      var isPasswordError = this.state.passwordError;
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { className: 'dropdown-toggle', 'data-toggle': 'dropdown', href: '#', onClick: this.clearPasswordErrors },
	              'Options ',
	              _react2.default.createElement('span', { className: 'glyphicon glyphicon-list' })
	            ),
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                isPasswordError ? _react2.default.createElement(
	                  'p',
	                  { className: 'error' },
	                  'There has been an error changing your password. Please try again.'
	                ) : null,
	                _react2.default.createElement(
	                  'form',
	                  { className: 'form login-form', name: 'changePassword', onSubmit: this.handleSubmit },
	                  _react2.default.createElement(
	                    'div',
	                    { className: 'form-group' },
	                    _react2.default.createElement(
	                    ...
	                    _react2.default.createElement('input', { type: 'text', className: 'form-control', name: 'old' })
	                  ),
	                  _react2.default.createElement(
	                    'div',
	                    { className: 'form-group' },
	                    ...
	                    _react2.default.createElement('input', { type: 'password', className: 'form-control', name: 'new' })
	                  ),
	                  _react2.default.createElement(
	                    'div',
	                    { className: 'form-group' },
	                    ...
	                    _react2.default.createElement('input', { type: 'password', className: 'form-control', name: 'confirm' })
	                  ),
	                  _react2.default.createElement('input', { type: 'submit', className: 'btn btn-sm btn-success margin-right-btn', value: 'Submit' }),
	                  _react2.default.createElement(
	                    'button',
	                    { type: 'button', className: 'btn btn-sm btn-danger', onClick: this.handleCancel },
	                    'Cancel'
	                  )
	                )
	              )
	  ...
	  _createClass(Search, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          { className: 'navbar-form navbar-left', name: 'searchSnippets', role: 'search', onSubmit: this.handleSubmit },
	          _react2.default.createElement(
	            'div',
	            { className: 'form-group' },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Navlinks = function (_React$Component) {
	  ...
	  function Navlinks() {
	    ...
	    var _this = _possibleConstructorReturn(this, (Navlinks.__proto__ || Object.getPrototypeOf(Navlinks)).call(this));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SnippetRecord = function (_React$Component) {
	  ...
	  _createClass(SnippetRecord, [{
	    ...
	    key: 'deleteSnippetSuccess',
	    value: function deleteSnippetSuccess() {
	      this.props.loadSnippets();
	      this.props.showHideComponent(["showSnippets", "showHomepage", "showSnippet", "showUpdate", "showCreate", "showSearchResults"]);
	      return;
	    }
	  }, {
	    key: 'deleteSnippetFail',
	    value: function deleteSnippetFail() {
	    ...
	    value: function deleteSnippetData(event) {
	      ...
	      fetch(api + '/snippets/' + recordID, { method: 'DELETE',
	        headers: {
	          'Authorization': 'Token token=' + store.user.token
	        },
	        mode: 'cors'
	        ...
	        if (!response.ok) {
	          return _this2.deleteSnippetFail();
	        } else {
	          return _this2.deleteSnippetSuccess();
	        }
	      });
	    }
	  }, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SnippetUpdate = function (_React$Component) {
	  ...
	  _createClass(SnippetUpdate, [{
	    ...
	    key: 'updateFail',
	    value: function updateFail() {
	      console.log('update failed');
	      return;
	    }
	  }, {
	    key: 'updateServerFail',
	    value: function updateServerFail() {
	      console.log('update failed');
	      return;
	    }
	  }, {
	    key: 'updateSnippet',
	    value: function updateSnippet(data) {
	      var _this2 = this;
	      ...
	      fetch(api + '/snippets/' + this.props.snippet.id, {
	        ...
	        if (response.ok) {
	          _this2.updateSuccess();
	        } else {
	          _this2.updateFail();
	        }
	      }).catch(function (error) {
	        console.log("Error in sending data to server: " + error.message);
	        _this2.updateServerFail();
	      });
	    }
	  }, {
	    key: 'handleSubmit',
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'p',
	          null,
	          'Save Snippet is a single page web application which allows users to store code for future reference.'
	        ),
	        _react2.default.createElement(
	          'p',
	          null,
